...
export const appsData: App[] = [
  {
    ...
    video: "",
    downloads: {
      github: "https://github.com/InledGroup/DroidTux/releases/latest",
      sourceforge: "",
      sourceCode: "https://github.com/InledGroup/DroidTux",
    },
  },
  {
    id: "geminissh",
  ...
  },
  {
    ...
    platform: ["Chrome", "Edge", "Brave"],
    shortDescription:
      "Abre tus archivos PDF en un modo oscuro real y personalizable.",
    description:
    ...
    screenshots: ["https://hosted.inled.es/demo-dark-reader.png"],
    video: "",
    downloads: {
      github:
        "https://github.com/InledGroup/dark-reader-PDF/archive/refs/heads/main.zip",
      sourceforge: "",
  ...
  },
  {
    ...
    shortDescription:
      "Navegación ultra-segura mediante aislamiento remoto y endurecimiento de red.",
    description:
  ...
  },
  {
    ...
    downloads: {
      github:
        "https://github.com/InledGroup/appinstall/releases/download/v8.0/appinstall8.1-ui-fix.deb",
      sourceforge:
        "https://sourceforge.net/projects/appinstall/files/latest/download",
      sourceCode: "https://github.com/InledGroup/appinstall",
    },
  },
  {
    id: "warp-vpn",
  ...
  },
  {
    ...
    downloads: {
      github:
        "https://github.com/InledGroup/start-omnibox/archive/refs/heads/main.zip",
      sourceforge: "",
  ...
  },
  {
    ...
    downloads: {
      github:
        "https://extensions.gnome.org/extension/8060/christian-cross-in-gnome-bar/",
      sourceforge: "",
  ...
  },
  {
    ...
    platform: ["Chrome", "Edge"],
    shortDescription:
      "Experimenta la productividad con Start como página de inicio.",
    description:
    ...
    downloads: {
      github:
        "https://github.com/InledGroup/start.newtab.chrome/archive/refs/heads/main.zip",
      sourceforge: "",
  ...
  },
  {
    ...
    downloads: {
      github:
        "https://github.com/InledGroup/windowserror/releases/download/v2.0/WindowsError2.zip",
      sourceforge:
        "https://sourceforge.net/projects/windowserror/files/latest/download",
  ...
  },
  {
    ...
    downloads: {
      github:
        "https://github.com/Inled-Group/winbsod/releases/download/v1.0/BSOD.app.zip",
      sourceforge: "",
  ...
  },
  {
    ...
    downloads: {
      github:
        "https://github.com/InledGroup/open-url-archive.is/archive/refs/heads/main.zip",
      sourceforge: "",
  ...
  },
  {
    ...
    notice: {
      type: "info",
      message:
        "Próximamente disponible una actualización con traducción de la interfaz al inglés y transformación en PWA.",
    },
  },
  {
    id: "inshare",
    ...
    downloads: {
      github:
        "https://github.com/InledGroup/inshare/archive/refs/heads/main.zip",
      sourceforge: "",
  ...
  },
  {
    ...
    screenshots: ["https://hosted.inled.es/moodlenotifier-screenshot1.png"],
    video: "",
    downloads: {
      github:
        "https://github.com/InledGroup/moodlenotifier/archive/refs/heads/main.zip",
      sourceforge: "",
    ...
    notice: {
      type: "info",
      message:
        "Próximamente disponible una actualización con traducción de la interfaz al inglés.",
    },
  },
  {
    id: "tabnest",
    ...
    shortDescription:
      "Tu centro de control personal en cada nueva pestaña: TV, radio y noticias.",
    description:
  ...
  {
    id: "codexbar-gnome",
    title: "CodexBar for GNOME",
    icon: "https://hosted.inled.es/codexbar-logo.png",
    platform: ["Linux", "GNOME"],
    shortDescription:
      "Monitoriza el uso de tus proveedores de IA directamente en la barra de GNOME.",
    description:
      "# CodexBar for GNOME\n\nCodexBar for GNOME es una extensión diseñada para usuarios de Linux que desean tener un control visual y rápido sobre el consumo de sus proveedores de IA favoritos directamente desde la shell de GNOME.\n\nEstá basado en el excelente proyecto **codexbar-cli** de steipete, adaptándolo para ofrecer una integración nativa en el escritorio Linux.\n\n### ¿Por qué CodexBar for GNOME?\n\nEl CLI original de codexbar no dispone de soporte web nativo en Linux para la visualización de datos. Esta extensión llena ese hueco, proporcionando una interfaz limpia y accesible que se integra perfectamente con tu flujo de trabajo diario.\n\n### Características y Próximas Actualizaciones\n\n- **Integración Nativa**: Visualiza tu consumo de IA sin abrir el navegador o la terminal.\n- **Basado en Estándares**: Aprovecha la potencia de codexbar-cli de steipete bajo el capó.\n- **Soporte Universal**: Compatible con todos los proveedores de CodexBar accesibles vía API.\n- **OpenAI Codex**: Ya disponible el soporte nativo para monitorizar OpenAI Codex.\n- **Próximamente Claude Code**: Muy pronto incluiremos soporte para Claude Code, permitiéndote monitorizar aún más herramientas desde un solo lugar.",
    screenshots: ["https://hosted.inled.es/codexbar for gnome.png"],
    video: "",
    downloads: {
      github: "https://extensions.gnome.org/extension/9841/codexbar/",
      sourceforge: "",
